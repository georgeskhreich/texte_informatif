...
const phase1Texts = [
  ...
  },
  {
    ...
    questions: [
      ...
      { text: "Comment se forment généralement les trous noirs ?", options: [{ id: 'a', text: "Par la collision de deux planètes" }, { id: 'b', text: "Suite à l'effondrement d'une étoile massive (supernova)" }, { id: 'c', text: "Par le refroidissement du soleil" }], correctAnswer: 'b' },
